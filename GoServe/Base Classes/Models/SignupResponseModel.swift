...
struct SignupResponseModel : Codable {
    let status : Int?
    let message : String?
    let signupResponseData : SignupResponseData?

    enum CodingKeys: String, CodingKey {

        case status = "status"
        case message = "message"
        case signupResponseData = "data"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        signupResponseData = try values.decodeIfPresent(SignupResponseData.self, forKey: .signupResponseData)
    }
